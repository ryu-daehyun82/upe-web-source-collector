...
_BLUEPRINTS: list[dict] = [
    ...
    # ── 확장 케이스 (변형/추가 의도) ──
    {
        "intent": "section_divider", "genre": ["proposal", "business_plan", "company_intro", "strategy_report"],
        "section_order": ["Visual", "Title", "Subtitle"],
        "weights": {"Visual": 0.7, "Title": 0.22, "Subtitle": 0.08},
        "text_visual": {"text": 0.2, "visual": 0.8},
        "when_to_use": "섹션 전환 — 큰 비주얼 배경 + 섹션 제목",
    },
    {
        "intent": "full_bleed_image", "genre": ["company_intro", "proposal"],
        "section_order": ["Image", "Callout"],
        "weights": {"Image": 0.85, "Callout": 0.15},
        "text_visual": {"text": 0.15, "visual": 0.85},
        "when_to_use": "전면 이미지 — 임팩트 비주얼 + 한 줄 콜아웃",
    },
    {
        "intent": "quote_testimonial", "genre": ["company_intro", "proposal"],
        "section_order": ["Quote", "PhotoGrid", "Caption"],
        "weights": {"Quote": 0.45, "PhotoGrid": 0.4, "Caption": 0.15},
        "text_visual": {"text": 0.45, "visual": 0.55},
        "when_to_use": "고객 인용/추천사 — 큰 따옴표 + 인물",
    },
    {
        "intent": "stat_highlight", "genre": ["business_plan", "company_intro", "strategy_report"],
        "section_order": ["Title", "Metric", "Metric", "Metric", "Caption"],
        "weights": {"Title": 0.1, "Metric": 0.72, "Caption": 0.18},
        "text_visual": {"text": 0.45, "visual": 0.55},
        "when_to_use": "핵심 수치 강조 — 큰 숫자 3~4개",
    },
    {
        "intent": "three_column", "genre": ["proposal", "business_plan"],
        "section_order": ["Title", "Visual", "Visual", "Visual", "Caption"],
        "weights": {"Title": 0.1, "Visual": 0.72, "Caption": 0.18},
        "text_visual": {"text": 0.3, "visual": 0.7},
        "when_to_use": "3단 구성 — 항목 3개 병렬(아이콘+설명)",
    },
    {
        "intent": "matrix_2x2", "genre": ["strategy_report", "proposal"],
        "section_order": ["Title", "Diagram", "Callout"],
        "weights": {"Title": 0.1, "Diagram": 0.68, "Callout": 0.22},
        "text_visual": {"text": 0.3, "visual": 0.7},
        "when_to_use": "2x2 매트릭스 — 사분면 포지셔닝(BCG 등)",
    },
    {
        "intent": "funnel_pyramid", "genre": ["business_plan", "strategy_report"],
        "section_order": ["Title", "Diagram", "Caption"],
        "weights": {"Title": 0.1, "Diagram": 0.72, "Caption": 0.18},
        "text_visual": {"text": 0.28, "visual": 0.72},
        "when_to_use": "퍼널/피라미드 — 단계 깔때기/계층",
    },
    {
        "intent": "gantt_schedule", "genre": ["proposal", "business_plan"],
        "section_order": ["Title", "Timeline", "Table", "Caption"],
        "weights": {"Title": 0.1, "Timeline": 0.45, "Table": 0.3, "Caption": 0.15},
        "text_visual": {"text": 0.45, "visual": 0.55},
        "when_to_use": "간트/일정표 — 타임라인 + 세부 표",
    },
    {
        "intent": "two_column_textviz", "genre": ["proposal", "strategy_report"],
        "section_order": ["Title", "Body", "Visual"],
        "weights": {"Title": 0.1, "Body": 0.35, "Visual": 0.55},
        "text_visual": {"text": 0.45, "visual": 0.55},
        "when_to_use": "좌텍스트·우비주얼 2단 — 설명 + 보조 그래픽",
    },
    {
        "intent": "data_table_dense", "genre": ["business_plan", "proposal", "strategy_report"],
        "section_order": ["Title", "Table", "Callout"],
        "weights": {"Title": 0.1, "Table": 0.72, "Callout": 0.18},
        "text_visual": {"text": 0.7, "visual": 0.3},
        "when_to_use": "상세 데이터표 — 표 밀도 높음(예외적 텍스트 우위)",
    },
    {
        "intent": "approach_methodology", "genre": ["proposal", "strategy_report"],
        "section_order": ["Title", "Flow", "Callout", "Body"],
        "weights": {"Title": 0.1, "Flow": 0.55, "Callout": 0.18, "Body": 0.17},
        "text_visual": {"text": 0.35, "visual": 0.65},
        "when_to_use": "접근법/방법론 — 단계 플로우 + 설명",
    },
    {
        "intent": "swot", "genre": ["strategy_report", "business_plan"],
        "section_order": ["Title", "Diagram", "Caption"],
        "weights": {"Title": 0.1, "Diagram": 0.7, "Caption": 0.2},
        "text_visual": {"text": 0.4, "visual": 0.6},
        "when_to_use": "SWOT — 4분면 강점/약점/기회/위협",
    },
    {
        "intent": "pricing_plan", "genre": ["proposal", "business_plan"],
        "section_order": ["Title", "Visual", "Visual", "Visual", "Metric"],
        "weights": {"Title": 0.1, "Visual": 0.6, "Metric": 0.3},
        "text_visual": {"text": 0.4, "visual": 0.6},
        "when_to_use": "가격/플랜 — 플랜 카드 3개 + 가격 수치",
    },
    {
        "intent": "expected_effect", "genre": ["proposal", "strategy_report"],
        "section_order": ["Title", "Visual", "Metric", "Callout"],
        "weights": {"Title": 0.1, "Visual": 0.45, "Metric": 0.28, "Callout": 0.17},
        "text_visual": {"text": 0.35, "visual": 0.65},
        "when_to_use": "기대효과 — 효과 비주얼 + 정량 지표",
    },
    {
        "intent": "appendix_reference", "genre": ["proposal", "business_plan", "strategy_report"],
        "section_order": ["Title", "Table", "Footnote", "Footer"],
        "weights": {"Title": 0.1, "Table": 0.6, "Footnote": 0.2, "Footer": 0.1},
        "text_visual": {"text": 0.75, "visual": 0.25},
        "when_to_use": "부록/참고 — 표·각주(텍스트 밀도 높음)",
    },
]
